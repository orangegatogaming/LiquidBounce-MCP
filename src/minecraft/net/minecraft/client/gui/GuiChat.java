...
public class GuiChat extends GuiScreen {
    ...
    private void sendAutocompleteRequest(String sex, String p_146405_2_) {
        if (LiquidBounce.commandManager.autoComplete(sex)) {
            waitingOnAutocomplete = true;

            String[] latestAutoComplete = LiquidBounce.commandManager.getLatestAutoComplete();

            if (sex.toLowerCase().endsWith(latestAutoComplete[latestAutoComplete.length - 1].toLowerCase()))
                return;
            ...
            this.mc.thePlayer.sendQueue.addToSendQueue(new C14PacketTabComplete(sex, blockpos));
