    ...
    public void drawBackground(int tint)
    {
        ...
        if(GuiBackground.Companion.getEnabled()) {
            if (LiquidBounce.INSTANCE.getBackground() == null) {
                ...
                worldRenderer.func_181662_b(0, height, 0.0D).func_181675_d();
                worldRenderer.func_181662_b(width, height, 0.0D).func_181675_d();
                worldRenderer.func_181662_b(width, 0, 0.0D).func_181675_d();
                worldRenderer.func_181662_b(0, 0, 0.0D).func_181675_d();
                instance.draw();
