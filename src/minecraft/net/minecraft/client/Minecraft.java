...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new net.ccbluex.liquidbounce.ui.client.GuiMainMenu(), this, this.serverName, this.serverPort));
        } else {
            this.displayGuiScreen(new net.ccbluex.liquidbounce.ui.client.GuiMainMenu());
        }
