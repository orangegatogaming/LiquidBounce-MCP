...
public class NameProtect extends Module {
    ...
    public void onText(final TextEvent event) {
        ...
        event.setText(StringUtils.replace(event.getText(), mc.thePlayer.getDisplayName().getUnformattedText(), ColorUtils.translateAlternateColorCodes(fakeNameValue.get()) + "§f"));
