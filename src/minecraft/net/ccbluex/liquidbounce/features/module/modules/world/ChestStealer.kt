...
class ChestStealer : Module() {
    ...
    fun onRender3D(event: Render3DEvent?) {
        ...
        // Chest title
        if (chestTitleValue.get() && (screen.lowerChestInventory == null || !screen.lowerChestInventory.displayName.unformattedText.contains(ItemStack(Item.itemRegistry.getObject(ResourceLocation("minecraft:chest"))).displayName)))
            return
