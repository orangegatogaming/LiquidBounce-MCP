...
class KillAura : Module() {
    ...
    private fun attackEntity(entity: EntityLivingBase) {
        ...
        if (keepSprintValue.get()) {
            ...
            // Enchant Effect
            if (EnchantmentHelper.func_152377_a(mc.thePlayer.heldItem, entity.creatureAttribute) > 0F)
        ...
        for (i in 0..2) {
            ...
            // Enchant Effect
            if (EnchantmentHelper.func_152377_a(mc.thePlayer.heldItem, target!!.creatureAttribute) > 0.0f || fakeSharpValue.get())
