...
class RemoteViewCommand : Command("remoteview", arrayOf("rv")) {
    ...
    override fun execute(args: Array<String>) {
        ...
        for (entity in mc.theWorld.loadedEntityList) {
            if (targetName == entity.displayName.unformattedText) {
                mc.renderViewEntity = entity
                chat("Now viewing perspective of §8${entity.displayName.unformattedText}§3.")
    ...
    override fun tabComplete(args: Array<String>): List<String> {
        ...
        return when (args.size) {
            1 -> return mc.theWorld.playerEntities
                .map { it.displayName.unformattedText }
