...
public final class EntityUtils extends MinecraftInstance {
    ...
    public static boolean isFriend(final Entity entity) {
        return entity instanceof EntityPlayer && entity.getDisplayName().getUnformattedText() != null &&
                LiquidBounce.fileManager.friendsConfig.isFriend(ColorUtils.stripColor(entity.getDisplayName().getUnformattedText()));
    }
