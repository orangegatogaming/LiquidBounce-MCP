...
class GuiMainMenu : GuiScreen(), GuiYesNoCallback {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        val a = "Warning!"
        val a1 = "This Build is in beta state so expect things to break!"
        Fonts.font35.drawString(a, this.width / 2F - Fonts.font35.getStringWidth(a) / 2,5F, Color(255,0,0).rgb, false)
        Fonts.font35.drawString(a1, this.width / 2F - Fonts.font35.getStringWidth(a1) / 2,5 + Fonts.font35.FONT_HEIGHT.toFloat(), Color(255,170,170).rgb, false)
